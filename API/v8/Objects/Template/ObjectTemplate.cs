...
using GMutagen.v8.Objects.Stubs.Implementation;
using GMutagen.v8.Objects.Template.Decsriptor;
using GMutagen.v8.Values;

using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.DependencyInjection.Extensions;

namespace GMutagen.v8.Objects.Template;
...
public static class DefaultGenerators
{
    ...
    public static IGenerator<IValue<TType>> GetExternalValueGenerator<TType>(Type targetType, Type idType)
    {
        ...
        var memoryObj =
            Activator.CreateInstance(typeof(v6.IO.Repositories.MemoryRepository<,>).MakeGenericType(idType, targetType), mapObj);
        var idGeneratorObj = Activator.CreateInstance(typeof(v6.Id.IncrementalGenerator<>).MakeGenericType(idType));
        var generatorObj =
            Activator.CreateInstance(typeof(v6.Values.ExternalValueGenerator<,>).MakeGenericType(idType, targetType),
