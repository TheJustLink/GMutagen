...
namespace GMutagen.v9.Resolving.Contexts;
...
public class Context
{
    ...
    public bool TryGetOptionFallback<T>(out T option, params OptionType[] optionTypes)
    {
        option = default;
    ...
    public static Context From(Context context, Type? type = null, Keys? keys = null, Options? options = null,
